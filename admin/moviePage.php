                        ...
                        <table class="w-full text-sm text-left text-white dark:text-gray-400">
                            ...
                            <tbody>
                                <div id='successMsg' class="hidden flex justify-center">
                                    <div id='success'
                                        class=" w-1/2 text-black font-bold text-center p-2 bg-lime-500 rounded-lg">
                                    </div>
                                </div>
                                <div id='errorMsg' class="hidden flex justify-center">
                                    <div id='error'
                                        class="text-white text-center w-[90%] mb-5 p-5 bg-red-500 rounded-lg "></div>
                                </div>
                                <?php
                                                ...
                                                <div class="p-6 text-center">
                                                    ...
                                                    <form action="../traitement/deleteMovie.php" method="post">
                                                        ...
                                                        <button value="<?= $movieId ?>"
                                                            data-modal-hide="popup-modal.<?= $movieId ?>" type="submit"
                                                            class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                            Yes, I'm sure
                                                        </button>
                                                    </form>
                                                    <button data-modal-hide="popup-modal.<?= $movieId ?>" type="button"
