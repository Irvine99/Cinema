        ...
        <div class=" h-[50px] bg-[#38354B]">
            ...
            <?php if(isset($_SESSION['id_user'])) {
                ...
                <?php }elseif ($_SESSION['role'] == 2) { ?>
                    <a href="./admin.php"><img class="rounded-full h-[50px] w-[50xp]" src="./../assets/img/pikahead.jpg" alt="" class=""></a>
                <?php }
                ?>
    ...
    <div class="py-5 bg-[#38354B]/30">
        ...
        <div class="mx-5 h-full flex justify-between items-end">
            ...
            <div class="flex items-end gap-2  ">
                ...
                <?php if(isset($_SESSION['id_user'])) { ?>
                 <span class=""><?= $_SESSION['username'] ?></span></h3>   
                <?php if($_SESSION['role'] == 0) { ?>
                    <a href="./profil.php"><img class="rounded-full h-[50px] w-[50xp]" src="./../assets/img/henrycavil.jpg" alt="" class=""></a>
                <?php }elseif ($_SESSION['role'] == 2) { ?>
                    <a href="../admin/admin.php"><img class="rounded-full h-[50px] w-[50xp]" src="./../assets/img/pikahead.jpg" alt="" class=""></a>
                <?php }
                ?>
