<div class="md:hidden">
    <div class="md:hidden py-3 flex justify-between">
        ...
        <div class="flex j items-end">
            ...
            <h1 class="text-sm text-white mr-3">Stanislas</h1>
            <a href="../page/profil.php"><img class="mb-[5px] h-[50px] w-[50px] rounded-full" src="./../assets/img/henrycavil.jpg" alt="" class=""></a> 
        </div>
    </div>
</div>
...
<div class="hidden md:block lg:hidden">
    <div class=" py-3 flex justify-between">
        ...
        <div class="flex j items-end">
            ...
            <h1 class="text-xl text-white mr-3">Stanislas</h1>
...
<div class="mb-10 hidden lg:block">
    <div class="py-3 flex justify-between">
        ...
        <div class="flex j items-end">
            ...
            <h1 class="text-2xl text-white mr-3">Stanislas</h1>
            <a href="../page/profil.php"><img class="mb-[5px] h-[100px] w-[100px] rounded-full" src="./../assets/img/henrycavil.jpg" alt="" class=""></a> 
        </div>
    </div>
</div>