...
<div class="md:hidden">
<h3 class="text-white my-3 text-1xl">Les derniers films sorties</h3>
  <!--Slider-->
...
<h3 class="text-white my-3 text-2xl">Les derniers films sorties</h3>
  <!--Slider-->
...
<h3 class="text-white my-3 text-3xl">Les derniers films sorties</h3>
  <!--Slider-->
