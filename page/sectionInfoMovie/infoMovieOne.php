    ...
    <div class="h-auto bg-cover bg-[url('./../assets/img/pikadetective.jpg')]">
        <div class="flex bg-[#1C1A29]/80 h-full">    
            <div class="mx-2 flex justify-between  my-5">
                <div class="flex justify-center w-1/2 items-center flex-col ">
                    <h1 class=" text-white text-xl mb-5 font-bold">Detective Pikachu</h1>
                    <div class="flex flex-col">
                        <div class="flex gap-3">
                            <img class="w-[35px] h-[35px]" src="./../assets/img/hourglass.png" alt="" class="">
                            <h3 class="text-white/80 text-md font-light">1 h 39 minute(s)</h3>
                        </div>
                        <div class="flex gap-3">
                            <img class="w-[35px] h-[35px]" src="./../assets/img/tags.png" alt="" class="">
                        ...
                        <div class="flex gap-3 items-center">
                            <img class="w-[35px] h-[35px]" src="./../assets/img/star.png" alt="" class="">
                            <h3 class="text-white/80 text-md font-light">8.9/10 sur IMDB</h3>
                        </div>
                        <div class="flex gap-3 items-center">
                            <img class="w-[35px] h-[35px]" src="./../assets/img/like.png" alt="" class="">
